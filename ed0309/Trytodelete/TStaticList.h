...
/**
 * Move todas as ocorrências de "valor" para o fim da lista,
 * preservando a ordem relativa e o deletando
 * @param TStaticList* lista
 * @param int valor: valor a ser removido;
 * @return bool: true se a lista não for NULL/se não for _is_empty ; false caso contrário
 */
